"""SEO gallery pages: the public UGC wall and per-video pages.

Only dependency is `list_video_gallery` from s3_uploader — no job state, no
auth. Interface: `router` only.
"""
